...
import { ArrowLeft } from "lucide-react"; // Импортируем иконку стрелки
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAF8F5] px-6">
      <form onSubmit={submit} data-testid="admin-login-form" className="relative w-full max-w-md bg-[#F0EBE1] border border-[#E2DACD] rounded-3xl p-9 shadow-[0_12px_40px_rgba(44,61,48,0.08)]">
        ...
        {/* Кнопка Назад в виде круглой стрелочки */}
        <Link 
          to="/" 
        ...
        <input data-testid="admin-login-input-password" type="password" className={inputCls + " mb-6"} value={password} onChange={(e) => setPassword(e.target.value)} required />
