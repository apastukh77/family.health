...
DEFAULT_SERVICES = [
    {"name_en": "Therapeutic back massage", "name_uk": "Терапевтичний масаж спини", "name_ro": "Masaj terapeutic al spatelui",
     ...
     "duration": "45", "price": "150", "category": "therapy", "image_url": "/videos/Therapeutic_back_massage.mp4"},
    ...
    {"name_en": "Anti-cellulite massage (hardware, manual, combo)", "name_uk": "Антицелюлітний масаж (апаратний, ручний, комбо)", "name_ro": "Masaj anticelulitic (aparat, manual, combo)",
     ...
     "duration": "50", "price": "170", "category": "wellness", "image_url": "/videos/Anti-cellulite_massage_(hardware,_manual,_combo).mp4"},
    {"name_en": "Pressotherapy", "name_uk": "Пресотерапія", "name_ro": "Presoterapie",
     ...
     "duration": "40", "price": "150-170", "category": "wellness", "image_url": "/videos/Pressotherapy.mp4"},
    {"name_en": "Myostimulation", "name_uk": "Міостимуляція", "name_ro": "Miostimulare",
     ...
     "duration": "45", "price": "150", "category": "wellness", "image_url": "/videos/Myostimulation.mp4"},
    {"name_en": "RF lifting (body, face)", "name_uk": "RF-ліфтинг (тіло, обличчя)", "name_ro": "Lifting RF (corp, față)",
     ...
     "duration": "45", "price": "170", "category": "wellness", "image_url": "/videos/RF_lifting_(body,_face).mp4"},
    {"name_en": "Back massage + vacuum therapy", "name_uk": "Масаж спини + вакуумна терапія", "name_ro": "Masaj de spate + terapie cu vid",
     ...
     "duration": "40", "price": "150", "category": "therapy", "image_url": "/videos/Back_massage_+_vacuum_therapy.mp4"},
    {"name_en": "Facial massage + alginate mask", "name_uk": "Масаж обличчя + альгінатна маска", "name_ro": "Masaj facial + mască alginată",
     ...
     "duration": "40", "price": "170", "category": "wellness", "image_url": "/videos/Facial_massage_+_alginate_mask.mp4"},
    ...
    {"name_en": "Face massage + back massage", "name_uk": "Масаж обличчя + масаж спини", "name_ro": "Masaj facial + masaj de spate",
     ...
     "duration": "90", "price": "280", "category": "wellness", "image_url": "/videos/Face_massage_+_back_massage.mp4"},
    {"name_en": "General massage + face massage", "name_uk": "Загальний масаж + масаж обличчя", "name_ro": "Masaj general + masaj facial",
     ...
     "description_uk": "Повне розслаблення тіла та обличчя в одному сеансі. Ідеальний спосіб відновити енергію та знайти внутрішню гармонію.",
     ...
     "duration": "100", "price": "300", "category": "wellness", "image_url": "/videos/General_massage_+_face_massage.mp4"},
    {"name_en": "Pressotherapy + face massage", "name_uk": "Пресотерапія + масаж обличчя", "name_ro": "Presoterapie + masaj facial",
     ...
     "duration": "80", "price": "280", "category": "wellness", "image_url": "/videos/Pressotherapy_+_face_massage.mp4"},
]
